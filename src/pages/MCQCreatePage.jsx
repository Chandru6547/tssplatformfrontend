        ...
        <div key={i} className="question-card">
          ...
          <div className="options-grid">
            <input
              ...
              value={q.optionA}
              onChange={e =>
                updateQuestion(i, "optionA", e.target.value)
              }
            />
            <input
              ...
              value={q.optionB}
              onChange={e =>
                updateQuestion(i, "optionB", e.target.value)
              }
            />
            <input
              ...
              value={q.optionC}
              onChange={e =>
                updateQuestion(i, "optionC", e.target.value)
              }
            />
            <input
              ...
              value={q.optionD}
              onChange={e =>
                updateQuestion(i, "optionD", e.target.value)
              }
            />
          </div>
